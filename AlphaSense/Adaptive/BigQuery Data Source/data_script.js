...
function testConnection(context) {
    ...
    var url = 'https://bigquery.googleapis.com/bigquery/v2/projects/as-finance-430214/datasets/storage/tables/a1_migration_arr';
    var method = 'GET';
    ...
    //Test the Data table API call
    var url = 'https://bigquery.googleapis.com/bigquery/v2/projects/as-finance-430214/datasets/storage/tables/a1_migration_arr/data';
    var method = 'GET';
    // Setup request in body, sample is using xml, but could be json
    var body = '';
    var headers = { 'Authorization': 'Bearer' + ' ' + accessToken };
...
function importData(context) {
    ...
    accessToken = getToken();
    var url = 'https://bigquery.googleapis.com/bigquery/v2/projects/as-finance-430214/datasets/storage/tables/a1_migration_arr/data?maxResults=1000';
    var method = 'GET';
    // Setup request in body, sample is using xml, but could be json
    var body = '';
    var headers = { 'Authorization': 'Bearer' + ' ' + accessToken };
    ...
    while(rowsProcessed < totalRows) {
        var url = 'https://bigquery.googleapis.com/bigquery/v2/projects/as-finance-430214/datasets/storage/tables/a1_migration_arr/data?maxResults=1000&pageToken=' + pageToken;
        var method = 'GET';
        // Setup request in body, sample is using xml, but could be json
        var body = '';
        var headers = { 'Authorization': 'Bearer' + ' ' + accessToken };
